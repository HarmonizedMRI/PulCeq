function [g,k,t,s] = genspiralvd(D, N, nl, gamp, gslew, dsamp, gts) 
% /*
%  *
...
%
% Inputs:
%    gts   gradient sample/raster time (sec)
%
% Example:
% Router = 2;                     % factor by which outer part is undersampled (outside dense core)
% dsamp = 150;                    % number of samples for the dense core
% fovvd = fov/nleafs;
% xresvd = n/nleafs;
% mxg = 5.0;   % G/cm
% mxslew = 150;   % T/m/s
% [g] = toppe.utils.spiral.genspivd2(fovvd, xresvd, Router, mxg, mxslew, dsamp);
% 
...
% derate gradients a bit to make sure they pass hardware checks
gslew = 0.995*gslew;
gamp = 0.995*gamp;
